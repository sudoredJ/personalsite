...
const Stars = () => {
    const StarsObject = (props: any) => {
        ...
        useFrame((_state, delta) => {
            ref.current!.rotation.x += (delta * globalCoords.x) / 2;  // Adjusted scaling factor
            ref.current!.rotation.y += (delta * globalCoords.y) / 2;  // Adjusted scaling factor
        });
        return (
